...
namespace Simple.BasicNet.Core.Handle
{
    public class ServiceConfigution
    {
        ...
        public int Port { get { return port; } set { if (value <= 1000) throw new Exception(); port = value; } }
        public string IpAddress { get { return string.Empty; } set { SetIpAddress(value); } }
